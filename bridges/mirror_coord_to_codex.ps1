...
$Files = @(
	...
	"ui\utils\projector.cpp",
	"ui\utils\projector_internal.h",
	"ui\utils\projector_keys_values.cpp",
	"ui\utils\projector_layout.cpp",
	"ui\utils\projector_links.cpp",
	"ui\utils\projector_nodes.cpp",
