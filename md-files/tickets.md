...
| MM-001 | Active | Party / MMSession | Strengthen Party to MM binding | Current Party -> MMSession reduction uses a member-set heuristic. Promote a stronger binding if Facts expose both `PARTY_SESSION_ID` and `MATCHMAKE_SESSION_ID`. |
